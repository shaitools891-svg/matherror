...
const Hero = () => {
    ...
    return (
        <section
            id="home"
            className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 transition-colors duration-500"
        >
            <div className="max-w-7xl mx-auto">
                <div className="text-center">
                    ...
                    >
                        সর্বশেষ আপডেট<br />
                        🎉 বাংলা প্রথম পত্রের উপকরণ যোগ করা হয়েছে! 
                    </p>
