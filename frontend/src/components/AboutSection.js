      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-10">
          ...
          <button
            ...
            className="flex items-center justify-between w-16 h-8 bg-gray-300 dark:bg-gray-700 rounded-full p-1 transition-colors duration-300"
            aria-label="Toggle dark mode"
          >
            <span className={`transform transition-transform duration-300 ${isDarkMode ? 'translate-x-8' : 'translate-x-0'}`}>
              <span className="flex items-center justify-center w-6 h-6 bg-white dark:bg-gray-900 rounded-full shadow-md">
                {isDarkMode ? (
