      ...
      <div className={`grid gap-[5em] grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mx-auto py-[3em] overflow-visible ${className || ""}`}>
        {items.map((item, index) => (
          ...
          >
            ...
            <span className="absolute top-full left-0 right-0 text-center whitespace-nowrap leading-[2] text-base opacity-100 transition-[opacity,transform] duration-300 ease-[cubic-bezier(0.83,0,0.17,1)] translate-y-0 group-hover:[transform:translateY(20%)]">
              {item.label}
            </span>
          </button>
        ))}
        ...
        <div className="mb-8 max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 dark:from-blue-600 dark:to-purple-700 rounded-xl p-6 text-white shadow-lg">
            ...
            <p className="text-blue-100">
              🎉 বাংলা ১ম পত্রের উপকরণ যোগ করা হয়েছে! আরও রিসোর্স শীঘ্রই আসছে।
            </p>
          </div>
        </div>
